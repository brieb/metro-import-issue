...
async function initializeGraph(processedReqUrl, metroServer) {
  const { entryFile, transformOptions, onProgress, graphOptions } = splitBundleOptions(
    parseOptionsFromUrl(processedReqUrl, new Set(["node"]))
  );
